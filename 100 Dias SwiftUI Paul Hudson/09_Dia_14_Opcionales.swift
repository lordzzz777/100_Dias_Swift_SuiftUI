...
// MARK: - Reto nº 9
 ...
 Tu desafío es el siguiente: escribe una función que acepte una matriz opcional de enteros y devuelva uno al azar. 
 Si falta la matriz o está vacía, devuelve un número aleatorio en el rango del 1 al 100.
 Si eso suena fácil, es porque aún no he explicado el traco: quiero que escribas tu función en una sola línea de código. 
 No, eso no significa que debas escribir mucho código y luego eliminar todos los saltos de línea, 
 deberías ser capaz de escribir todo esto en una línea de código.
*/
